...
## Security Keys
It is a good manner to put security keys in some places. We can have huggingface tokens, wandb tokens, etc. You can put them anywhere you like on the server in a file. Then, you just need `source xxx.txt` and then export them in your script files.
